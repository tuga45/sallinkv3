...
export const AnimatedBeam: React.FC<AnimatedBeamProps> = ({
  ...
  const inViewport = useInViewport(containerRef as RefObject<Element>);
  ...
  useEffect(() => {
    ...
    const scrollTarget: Element | Window = containerRef.current?.ownerDocument?.defaultView || window;
    const onScroll = () => {
      updatePath();
    };
    ...
    // Track scroll to keep path aligned
